...
def eval_model():
    ...
    generation_config.max_new_tokens = True
    ...
    data_path = '/mnt/bn/algo-masp-nas-2/masp_data/shikra_data/coco_pope_random_cap.jsonl'

    data_paths = {'random':'/mnt/bn/algo-masp-nas-2/masp_data/shikra_data/coco_pope_random_cap.jsonl', 
                  'popular':'/mnt/bn/algo-masp-nas-2/masp_data/shikra_data/coco_pope_popular_cap.jsonl',
                  'adversarial':'/mnt/bn/algo-masp-nas-2/masp_data/shikra_data/coco_pope_adversarial_cap.jsonl'
                 }
    if data_args.data_type:
        print(data_args.data_type)
        data_path = data_paths[data_args.data_type]
    data = []
    ...
    test_dataset = CustomDataset(data, tokenizer, image_processor, model.config)
    ...
    if local_rank == 0:
        ...
        for test_result in test_results.predictions:
            print(test_result)
