deepspeed --master_port 25000 --num_nodes=1 --num_gpus=8 llava/feature/extract.py \
    --deepspeed /opt/tiger/LLaVA1.5/scripts/zero2.json \
    --model_name_or_path /mnt/bn/bohanzhainas1/Public_Models/vicuna-13b-v1.5 \
    --version plain \
    --data_path /mnt/bn/shijiaynas/OBELISC_images/image_extract_conv_filtered.json \
    --image_folder /mnt/bn/shijiaynas/OBELISC_images \
